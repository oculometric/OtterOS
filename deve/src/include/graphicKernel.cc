...
// void initScreen(){
// 		ScreenBufferSize = VbeModeInfoBlock.XResolution *
// VbeModeInfoBlock.YResolution
// 																										*
// (VbeModeInfoBlock.BitsPerPixel/8); 		ScreenZBuffer = alloc(ScreenBufferSize);
...
static void fillRect(unsigned char *vram, int x, int y, unsigned char w,
